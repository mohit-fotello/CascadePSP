...
def parse_args():
    ...
    parser.add_argument("--image_dir", required=True, help="Image folder, relative to --data unless absolute.")
    parser.add_argument("--raw_mask_dir", required=True, help="BiRefNet raw-mask folder, relative to --data unless absolute.")
    parser.add_argument("--gt_mask_dir", required=True, help="Ground-truth mask folder, relative to --data unless absolute.")
    ...
    parser.add_argument("--weights_dir", default="/workspace/weights", help="Directory to save checkpoints.")
    parser.add_argument("--compile", action="store_true", default=False, help="Enable torch.compile (off by default).")
...
def main():
    ...
    saver = ModelSaver(long_id, save_dir=args.weights_dir)
